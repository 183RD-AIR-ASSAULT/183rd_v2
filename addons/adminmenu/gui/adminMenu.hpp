...
class GVAR(RscButtonMenu): RscButtonMenu {
    ...
    sizeEx = QUOTE(OETA_ADMINMENU_STD_SIZEX_L);
...
class ADDON
{
    ...
    class Controls
    {
        ...
        {
            idc = -1;
            text = "183rd Air Assault Admin Menu";
            style = 0;
        ...
        class TabMessageLog: TabDashboard
        {
            ...
            text = "Logs";
            tooltip = "Status and debug messages from 183rd Air Assault components";
        ...
        class GroupDashboard: GroupBase
        {
            ...
            w =  QUOTE(OETA_GROUPBASE_W);
            h = QUOTE(OETA_GROUPBASE_H);
