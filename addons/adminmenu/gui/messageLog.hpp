class Controls
{
    class BackgroundMessagesList: RscText
    {
        x = 0;
        y = 0;
        w = QUOTE(OETA_ADMINMENU_MSGS_W_LIST);
        h = QUOTE(OETA_ADMINMENU_MSGS_H_LIST);
    ...
    class ListMessages: RscListBox
    {
        ...
        rowHeight = QUOTE(OETA_ADMINMENU_STD_HEIGHT);
        colorText[] = {1,1,1,1};
    ...
    class ButtonPrintSelected: GVAR(RscButtonMenu)
    {
        ...
        x = QUOTE(0 * OETA_ADMINMENU_STD_WIDTH);
        y = QUOTE(19.5 * OETA_ADMINMENU_STD_HEIGHT);
        w = QUOTE(9 * OETA_ADMINMENU_STD_WIDTH);
    };
    ...
    class ButtonPrintAll: GVAR(RscButtonMenu)
    {
        ...
        colorBackground[] = {0, 0, 0, 1};
        x = QUOTE(9.1 * OETA_ADMINMENU_STD_WIDTH);
        y = QUOTE(19.5 * OETA_ADMINMENU_STD_HEIGHT);
        w = QUOTE(7 * OETA_ADMINMENU_STD_WIDTH);
    };
};
