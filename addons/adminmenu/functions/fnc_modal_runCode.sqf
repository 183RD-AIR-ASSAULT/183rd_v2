...
_ctrlButton ctrlAddEventHandler ["buttonClick", {
    ...
    if (_editText isEqualTo "") then {
        systemChat "[183rd Air Assault Admin Menu] Code field is empty";
    } else {
        ...
        systemChat format ["[183rd Air Assault Admin Menu] Code was executed on %1", _ctrlCombo lbText (lbCurSel _ctrlCombo)];
