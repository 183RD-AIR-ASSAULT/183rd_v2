...
Parameters:
    ...
    _tag - Tag that message will be prefixed with [String, defaults to "[183rd Air Assault Log]"]
...
Examples:
    (begin example)
        ["Everything is on fire!",true,"[183rd Air Assault Firealarm]"] call OETA_adminmenu_fnc_log;
    (end)
    (begin example)
