...
// OETA - common
force oeta_common_DynamicGroups = true;
force oeta_common_DynamicSim = true;
force oeta_common_FlipVehicle = true;
force oeta_common_TFARTerrainInterference = 1;
force oeta_common_TFARTransmitRange = 2.5;
...
// 183rd Air Assault - Channels
FORCE oeta_Channels_CommandDuration = 0;
FORCE oeta_Channels_CommandText = false;
