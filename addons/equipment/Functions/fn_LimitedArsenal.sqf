/*
Function: OETA_fnc_LimitedArsenal
...
Description:
 ...
 OETA_fnc_Arsenal, only the items in the container change.
...
Examples:
 (begin example)
  [this] call OETA_fnc_LimitedArsenal;
  [this, "Aegis", 50] call OETA_fnc_LimitedArsenal;
  [this, "VANILLA"] call OETA_fnc_LimitedArsenal;
  [MyAmmoCrate, "RHS", 0] call OETA_fnc_LimitedArsenal;
 (end)
...
call {
 if (_Type isEqualto 0) exitwith {_Type = "OETA"};
