...
class CfgWeapons {
    ...
    class GVAR(xm157_prototype ): ace_xm157_prototype {
        ...
        scopeArsenal=2;
        author = QAUTHOR;
        displayName = "[OETA] XM157 pre-Alpha";
    };
    ...
    class GVAR(optic_AMS_base): ItemCore {
        author = QAUTHOR;
        displayName="[OETA] AMS Base";
        descriptionShort="[OETA] AMS (NVG)";
    ...
    class GVAR(optic_AMSTI_base): ItemCore {
        author = QAUTHOR;
        displayName="[OETA] AMS-TI Base";
        descriptionShort="[OETA] AMS (NVG/TI)";
        _generalMacro="optic_AMS_base";
        scope=0;
        scopeCurator=0;
        scopeArsenal=0;
    ...
    class GVAR(optic_DMS): ace_xm157_prototype {
        ...
        scopeCurator=2;
        scopeArsenal=2;
        displayName="[OETA] XM157 - AMS Base";
        descriptionShort="[OETA] AMS (NVG)";
