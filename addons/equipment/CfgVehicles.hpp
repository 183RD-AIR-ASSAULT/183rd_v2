...
class CfgVehicles {
    ...
    class GVAR(arsenal): NATO_Box_Base {
        ...
        hiddenSelectionsTextures[]= {
            "z\oeta\addons\Equipment\data\ammobox_signs_caA.paa",
            "z\oeta\addons\Equipment\data\ammo_oeta_co.paa"
        };
    ...
    class GVAR(arsenalW): NATO_Box_Base {
        ...
        scopeCurator = 2;
        author = QAUTHOR;
        displayName = "[OETA] Arsenal Winter";
        model="A3\Weapons_F\Ammoboxes\AmmoVeh_F";
        icon="iconCrateVeh";
        ace_dragging_canDrag = 0;
        ace_dragging_canCarry = 0;
        ...
        hiddenSelectionsTextures[]= {
            "z\oeta\addons\Equipment\data\ammobox_signs_caA.paa",
            "z\oeta\addons\Equipment\data\ammo_oeta_W_co.paa"
        };
        class TransportMagazines {
        };
        class TransportWeapons {
    ...
    class GVAR(arsenalD): NATO_Box_Base {
        ...
        scopeCurator = 2;
        author = QAUTHOR;
        displayName = "[OETA] Arsenal Desert";
        model="A3\Weapons_F\Ammoboxes\AmmoVeh_F";
        icon="iconCrateVeh";
        ace_dragging_canDrag = 0;
        ace_dragging_canCarry = 0;
        ...
        hiddenSelectionsTextures[]= {
            "z\oeta\addons\Equipment\data\ammobox_signs_caA.paa",
            "z\oeta\addons\Equipment\data\ammooeta_D_co.paa"
        };
        class TransportMagazines {
        };
        class TransportWeapons {
    ...
    class GVAR(arsenalT): NATO_Box_Base {
        ...
        scopeCurator = 2;
        author = QAUTHOR;
        displayName = "[OETA] Arsenal Tropical";
        model="A3\Weapons_F\Ammoboxes\AmmoVeh_F";
        icon="iconCrateVeh";
        ace_dragging_canDrag = 0;
        ace_dragging_canCarry = 0;
        ...
        hiddenSelectionsTextures[]= {
            "z\oeta\addons\Equipment\data\ammobox_signs_caA.paa",
            "z\oeta\addons\Equipment\data\ammooeta_T_co.paa"
        };
        class TransportMagazines {
        };
        class TransportWeapons {
    ...
    class GVAR(arsenalC): NATO_Box_Base {
        ...
        scopeCurator = 2;
        author = QAUTHOR;
        displayName = "[OETA] Arsenal Civllian";
        model="A3\Weapons_F\Ammoboxes\AmmoVeh_F";
        icon="iconCrateVeh";
        ace_dragging_canDrag = 0;
        ace_dragging_canCarry = 0;
        ...
        hiddenSelectionsTextures[]= {
            "z\oeta\addons\Equipment\data\ammobox_signs_caA.paa",
            "z\oeta\addons\Equipment\data\ammooeta_co_c_.paa"
        };
        class TransportMagazines {
        };
        class TransportWeapons {
    ...
    class GVAR(resupply): NATO_Box_Base {
        ...
        scopeCurator = 2;
        author = QAUTHOR;
        displayName = "[OETA] Arsenal Resupply";
        model="A3\Weapons_F\Ammoboxes\AmmoVeh_F";
        icon="iconCrateVeh";
        ace_dragging_canDrag = 0;
        ace_dragging_canCarry = 0;
        ...
        hiddenSelectionsTextures[]= {
            "z\oeta\addons\Equipment\data\ammobox_signs_caA.paa",
            "z\oeta\addons\Equipment\data\resupplyoeta.paa"
        };
        class TransportMagazines {
        };
        class TransportWeapons {
    ...
    class GVAR(Item_Vector_Designator): ACE_Item_Vector {
        author = "NemessisRE";
        displayName = "[OETA] ACE Vector Designator (NVG/TI)";
        class TransportItems {
    ...
    class GVAR(Item_Vector_Designator_NVG): GVAR(Item_Vector_Designator) {
        displayName = "[OETA] ACE Vector Designator (NVG)";
        class TransportItems {
            class GVAR(Vector_Designator) {
                name=QGVAR(Vector_Designator);
                count=1;
