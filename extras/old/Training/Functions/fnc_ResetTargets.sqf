...
/*
Function: oeta_Training_fnc_ResetTargets
...
Examples:
    (begin example)
        [this, "Reset Targets", [1200,4200,0], 250] call oeta_Training_fnc_ResetTargets;
        [MyLaptopName, "Reset 300m Range", [5500,3522,0], 300] call oeta_Training_fnc_ResetTargets;
    (end)
