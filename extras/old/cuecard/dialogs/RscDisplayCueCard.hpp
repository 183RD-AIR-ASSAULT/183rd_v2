class RscDisplayCueCard {
    ...
    scriptPath = "OETAisplays";
    onLoad = "[""onLoad"",_this,""RscDisplayCueCard"",'OETAisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onUnload = "[""onUnload"",_this,""RscDisplayCueCard"",'OETAisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    movingEnable = "true";
